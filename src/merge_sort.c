 ...
 *  @warning Validates input parameters; invalid cases (NULL array, negative
 * indices, invalid mid) trigger an error message and exit early.
 */
 ...
 *  @note Uses a divide-and-conquer approach with merging. Time complexity is
